...
final evidenceDir = Directory(r'd:\Flutter\car_rental_monorepo\docs\evidence\phase29-17-cross-platform-fulfillment');
...
Future<void> saveScreenshot(WidgetTester tester, GlobalKey key, String filename) async {
  ...
  await tester.runAsync(() async {
    ...
    if (renderObject is RenderRepaintBoundary) {
      ...
      // ignore: avoid_print
      print('[PHASE_29_17_EVIDENCE] ${file.path} (${file.lengthSync()} bytes)');
    }
  });
}
...
void main() {
  ...
  testWidgets('01_host_yard_handover_staging.png', (tester) async {
    ...
    await saveScreenshot(tester, key, '01_host_yard_handover_staging.png');
  });

  testWidgets('02_doorstep_dispatch_coordinates.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '02_doorstep_dispatch_coordinates.png');
  });

  testWidgets('03_transit_hub_arrival_banner.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '03_transit_hub_arrival_banner.png');
  });

  testWidgets('04_handover_pre_trip_inspection.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '04_handover_pre_trip_inspection.png');
  });

  testWidgets('05_handover_otp_verification.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpWidget(
      createSubject(
        bookingId: 'bk_mock_host_yard',
        key: key,
        child: const HandoverInspectionPage(bookingId: 'bk_mock_host_yard', initialStep: 2),
      ),
    );
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '05_handover_otp_verification.png');
  });

  testWidgets('06_active_rental_ongoing.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpWidget(
      createSubject(
        ...
        key: key,
        child: const VendorBookingDetailPage(bookingId: 'bk_mock_active_rental'),
      ),
    );
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '06_active_rental_ongoing.png');
  });

  testWidgets('07_return_inspection_odometer.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '07_return_inspection_odometer.png');
  });

  testWidgets('08_completed_booking_immutable_snapshot.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '08_completed_booking_immutable_snapshot.png');
  });

  testWidgets('09_different_return_branch_relocation.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '09_different_return_branch_relocation.png');
  });
