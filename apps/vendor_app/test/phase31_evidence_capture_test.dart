...
void main() {
  ...
  group('Phase 31 Vendor Visual Evidence Capture Suite', () {
    final vendorItems = [
      NotificationModel(
        id: 'vnd-notif-01',
        userId: 'vnd_01',
    ...
    testWidgets('Capture 07, 08, 09: Vendor Operational Notifications', (tester) async {
      ...
      // 07: Vendor Booking operational notification
      await saveScreenshot(tester, boundaryKey, '07_vendor_booking_operational_notification.png');

      // 08: Vendor Handover / Return notification
      await saveScreenshot(tester, boundaryKey, '08_vendor_handover_return_notification.png');

      // 09: Vendor Escrow & payout notification
      await saveScreenshot(tester, boundaryKey, '09_vendor_escrow_payout_notification.png');
    });
  });
}
