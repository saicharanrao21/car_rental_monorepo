...
final evidenceDir = Directory(r'd:\Flutter\car_rental_monorepo\docs\evidence\phase29-15-vendor-booking-lifecycle');
...
void main() {
  ...
  testWidgets('01_confirmed_booking.png', (tester) async {
    ...
    await saveScreenshot(tester, key, '01_confirmed_booking.png');
  });

  testWidgets('02_handover_ready.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpWidget(
      createSubject(
        bookingId: 'bk_mock_handover_ready',
        key: key,
        child: const VendorBookingDetailPage(bookingId: 'bk_mock_handover_ready'),
      ),
    );
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '02_handover_ready.png');
  });

  testWidgets('03_active_rental.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '03_active_rental.png');
  });

  testWidgets('04_return_pending.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpWidget(
      createSubject(
        ...
        key: key,
        child: const VendorBookingDetailPage(bookingId: 'bk_mock_return_pending'),
      ),
    );
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '04_return_pending.png');
  });

  testWidgets('05_return_inspection.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpWidget(
      createSubject(
        bookingId: 'bk_mock_return_pending',
        key: key,
        child: const ReturnInspectionPage(bookingId: 'bk_mock_return_pending', initialStep: 0),
      ),
    );
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '05_return_inspection.png');
  });

  testWidgets('06_completed_booking.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpWidget(
      createSubject(
        ...
        key: key,
        child: const VendorBookingDetailPage(bookingId: 'bk_mock_return_inspected'),
      ),
    );
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '06_completed_booking.png');
  });

  testWidgets('07_damage_claim_settlement.png', (tester) async {
    tester.view.physicalSize = const Size(1080, 2400);
    tester.view.devicePixelRatio = 1.0;
    addTearDown(tester.view.resetPhysicalSize);
    addTearDown(tester.view.resetDevicePixelRatio);
    ...
    await tester.pumpAndSettle();
    await saveScreenshot(tester, key, '07_damage_claim_settlement.png');
  });
}
